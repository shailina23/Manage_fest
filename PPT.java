...
public class PPT extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (collegeid.isEmpty()) JOptionPane.showMessageDialog(this,"Collegeid not Entered");
            ...
            try
            {
                ...
                String query="SELECT name,phoneno,year,Branch,house FROM PPT WHERE collegeid='"+collegeid+"';";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {    Class.forName("java.sql.DriverManager");
            ...
            Statement stmt = (Statement) con.createStatement();
            String query="INSERT INTO PPT VALUES ('"+collegeid+"','"+Name+"','"+Phoneno+"','"+Branch+"','"+Year+"','"+house+"');";
